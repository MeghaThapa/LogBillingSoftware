...
<form action="/sale" class="row g-3 needs-validation " method="POST" novalidate>
    @csrf
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="input-group has-validation">
          <select name="customer_id" id="salesSelect" class="form-control " required>
    ...
    <div class="row">
      <label for="validationCustom02" class="form-label fw-bold">Sales type </label>
    <div>
        <select name="salesType" class="form-select">
    ...
    <div class="row">
      ...
      <div>
        <input type="date"class="form-control" name="sales_date"id ="validationCustom04" required>
      </div>
        <div class="invalid-feedback">
