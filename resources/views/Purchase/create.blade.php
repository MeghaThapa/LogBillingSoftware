...
<form action="/purchase" class="row g-3 needs-validation " method="POST" novalidate>
    @csrf
    <div class="row">
      <label for="validationCustom01" class="form-label fw-bold">Invoice Number</label>
      <div>
      <input type="text" class="form-control" disabled value= "{{ $value}}" name="invoice_number" id="validationCustom01" autofocus required>
    </div>
    ...
    <div class="row">
        <label for="validationCustomUsername" class="form-label fw-bold">Supplier Name</label>
    ...
    <div class="row">
      <label for="validationCustom02" class="form-label fw-bold">Bill No</label>
    <div>
      <input type="text" class="form-control" id="validationCustom02" name="bill_no" required>
    </div>
      <div class="invalid-feedback">
        Enter Bill Number!!
      </div>
   ...
   <div class="row">
      ...
      <div>
        <input type="date"class="form-control"name="transaction_date" id ="validationCustom04" >
      </div>
        <div class="invalid-feedback">
