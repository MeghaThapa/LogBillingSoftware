...
<form action="/supplier" class="row g-3 needs-validation " method="POST" novalidate>
    @csrf
    <div class="row">
      <label for="supplierName" class="form-label fw-bold">Name</label>
      <div>
      <input type="text" class="form-control" name="name" id="supplierName" autofocus required>
    </div>
    ...
    <div class="row">
        ...
        <div>
          <input type="number" class="form-control" name="contact" id="supplierContact"  required>
        </div>
          <div class="invalid-feedback">
    ...
    <div class="row">
      ...
      <div>
        <input type="number"class="form-control" name="pan_no" required>
      </div>
        <div class="invalid-feedback">
          Please enter pan no!!
        </div>
   ...
   <div class="row">
      ...
      <div>
        <input type="number"class="form-control"name="vat_no" id ="supplierVat" >
      </div>
        {{-- <div class="invalid-feedback">
          Please enter vat no!!
        </div> --}}
